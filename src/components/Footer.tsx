            ...
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    ...
                    <div className="flex gap-4">
                        <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#004aad] transition-colors"><Facebook className="w-4 h-4" /></a>
                        <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#004aad] transition-colors"><Linkedin className="w-4 h-4" /></a>
                        <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#004aad] transition-colors"><Instagram className="w-4 h-4" /></a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <Link href="/membership/become-member" className="bg-[#004aad] text-white px-6 py-3 rounded-full font-bold w-full text-center block hover:bg-[#4a8a52] transition-colors shadow-lg">Become a Member</Link>
                </div>
            </div>
