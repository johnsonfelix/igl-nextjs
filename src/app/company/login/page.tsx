            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 px-4 py-3 pr-12 focus:ring-2 focus:ring-[#004aad] focus:border-[#004aad] outline-none transition-all placeholder:text-gray-400"
                  value={password}
