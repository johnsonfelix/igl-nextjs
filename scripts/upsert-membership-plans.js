...
const plans = [
    {
        ...
        price: 0,
        description: 'No Fee',
        paymentProtection: 'Not Applicable',
    ...
    },
    {
        ...
        paymentProtection: 'Coverage up to USD 8,000',
        discountPercentage: 0.0,
        features: [
    ...
    },
    {
        ...
        paymentProtection: 'Coverage up to USD 12,000',
    ...
    },
    {
        ...
        paymentProtection: 'Coverage up to USD 15,000',
    ...
    },
    {
        ...
        paymentProtection: 'Coverage up to USD 25,000',
    ...
    for (const plan of plans) {
        const upserted = await prisma.membershipPlan.upsert({
            ...
            update: {
                ...
                paymentProtection: plan.paymentProtection,
